...
export function PubHero() {
  ...
  return (
    ...
    >
      ...
      <div className="pub-container relative flex min-h-[min(100svh,54rem)] items-center py-12 md:py-16 lg:min-h-svh lg:justify-center lg:py-20">
        <div className="w-full max-w-xl -translate-y-2 border-l-4 border-pub pl-5 text-left md:-translate-y-4 md:pl-7 lg:max-w-4xl lg:translate-y-0 lg:border-l-0 lg:pl-0 lg:text-center xl:max-w-5xl">
          ...
          <h1 id="pub-hero-heading" className="mt-4 lg:mt-6">
            ...
            <span className="mt-4 block max-w-[18ch] font-sans text-[1.55rem] font-medium leading-[1.15] text-pub-cream sm:text-[1.9rem] md:mt-5 md:text-[2.15rem] lg:mx-auto lg:mt-7 lg:max-w-[16ch] lg:text-[3.25rem] xl:text-[3.75rem]">
              {hero.title}
            </span>
          </h1>
          <p className="mt-5 max-w-md text-base leading-relaxed text-pub-muted md:text-lg lg:mx-auto lg:mt-7 lg:max-w-2xl lg:text-xl lg:leading-relaxed xl:text-[1.35rem]">
            {hero.subtitle}
          </p>
          <div className="mt-8 flex flex-col gap-3 sm:flex-row lg:mt-10 lg:justify-center lg:gap-4">
